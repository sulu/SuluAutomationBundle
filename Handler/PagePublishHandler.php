...
/**
 * Provides handler for publishing pages.
 */
class PagePublishHandler implements AutomationTaskHandlerInterface, RetryTaskHandlerInterface
{
    ...
    {
        return TaskHandlerConfiguration::create($this->translator->trans('sulu_automation.publish', [], 'admin'));
    }
